...
The requests conform to the  [HL7 Context-Aware Knowledge Retrieval (Infobutton) Knowledge Request URL-Based Implementation Guide](http://wiki.hl7.org/index.php?title=Product_Infobutton#Product_Name_-_HL7_V3_IG:_URL-Based_Implementations_of_the_Context-Aware_Information_Retrieval_.28Infobutton.29). A screen shot of the application's response to a request for information on [ | Asthma|](http://snomed.info/id/195967001 "195967001 | Asthma |") is provided below:

<figure><img src="images/123897692.png" alt="" title=""><figcaption><p>Figure 3: MedlinePlus Connect web application response to request for information on problem code 195967001 | Asthma (disorder) |</p></figcaption></figure>
...
Footnotes Ref | Notes  
---|---  
[1](https://confluence.ihtsdotools.org/display/DOCCDS/National+Institutes+of+Health%3A+Intramural+Research+Program#FootnoteMarker1-0 "Footnote: Click to return to reference in text") |  <https://irp.nih.gov/about-us/what-is-the-irp>  
[2](https://confluence.ihtsdotools.org/display/DOCCDS/National+Institutes+of+Health%3A+Intramural+Research+Program#FootnoteMarker2-0 "Footnote: Click to return to reference in text") |  <https://en.wikipedia.org/wiki/National_Institutes_of_Health>  
[3](https://confluence.ihtsdotools.org/display/DOCCDS/National+Institutes+of+Health%3A+Intramural+Research+Program#FootnoteMarker3-0 "Footnote: Click to return to reference in text") |  <https://www.irp.nih.gov/about-us/our-programs>  
[4](https://confluence.ihtsdotools.org/display/DOCCDS/National+Institutes+of+Health%3A+Intramural+Research+Program#FootnoteMarker4-0 "Footnote: Click to return to reference in text") |  Based on content from <https://vsac.nlm.nih.gov/>
