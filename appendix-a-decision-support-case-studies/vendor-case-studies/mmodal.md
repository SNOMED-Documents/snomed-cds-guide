...
{% hint style="info" %}
"M\*Modal is a next-generation healthcare technology and services company committed to transforming the physician documentation experience with artificial intelligence powered solutions that span the documentation lifecycle from capturing the complete patient narrative to coding. M\*Modal solutions help over 250,000 physicians with the smarter creation of higher-quality clinical notes directly in any EHR, thereby creating time to care."

For more information please visit: [https://mmodal.com/](https://mmodal.com/)
{% endhint %}
...
**Finding** : [27925004 <mark style="color:blue;">|</mark> Nodule (morphologic abnormality)<mark style="color:blue;">|</mark>](http://snomed.info/id/27925004)

**Site** : [362900002 <mark style="color:blue;">|</mark> Entire middle lobe of lung (body structure)<mark style="color:blue;">|</mark>](http://snomed.info/id/362900002)

**Laterality** : [24028007 <mark style="color:blue;">|</mark> Right (qualifier value)<mark style="color:blue;">|</mark>](http://snomed.info/id/24028007)

**Component** : [35702001 <mark style="color:blue;">|</mark> Solid (qualifier value)<mark style="color:blue;">|</mark>](http://snomed.info/id/35702001)
